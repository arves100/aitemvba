...
unsigned char gbpPythonSerial(u8 inp)
{
	return theApp.pPython->ProcessLink(inp);
}

void MainWnd::OnOptionsPythonScript()
{
	theApp.winGbPytonScriptEnabled = !theApp.winGbPytonScriptEnabled;
	if (theApp.winGbPytonScriptEnabled)
...
void MainWnd::OnUpdateOptionsPythonScript(CCmdUI* pCmdUI) 
{
  pCmdUI->SetCheck(gbpSerialFunction != NULL);
}
...
void MainWnd::OnOptionsLink() 
{
	// TODO: Add your command handler code here
	LinkMenu *dlg = new LinkMenu;
	dlg->Create(IDD_LINK, this);
