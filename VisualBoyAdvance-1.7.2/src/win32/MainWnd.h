...
class MainWnd : public CWnd
{
 ...
 protected:
  ...
  afx_msg void OnStartMyAI();
  afx_msg void OnUpdateStartMyAI(CCmdUI* pCmdUI);
  afx_msg void OnStopMyAI();
  afx_msg void OnUpdateStopMyAI(CCmdUI* pCmdUI);

  afx_msg void OnStartPythonScript();
  afx_msg void OnUpdateStartPythonScript(CCmdUI* pCmdUI);
  afx_msg void OnStopPythonScript();
  afx_msg void OnUpdateStopPythonScript(CCmdUI* pCmdUI);

  afx_msg void OnStartAnimationRecord();
  afx_msg void OnUpdateStartAnimationRecord(CCmdUI* pCmdUI);
  afx_msg void OnStopAnimationRecord();
  afx_msg void OnUpdateStopAnimationRecord(CCmdUI* pCmdUI);

  afx_msg void OnStartWriteGMDFile();
  
  afx_msg void OnStartAutoBattle();
  afx_msg void OnUpdateStartAutoBattle(CCmdUI* pCmdUI);
  afx_msg void OnStopAutoBattle();
  afx_msg void OnUpdateStopAutoBattle(CCmdUI* pCmdUI);
  ...
  afx_msg void OnOptionsPythonScript();
  afx_msg void OnUpdateOptionsPythonScript(CCmdUI* pCmdUI);
