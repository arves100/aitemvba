...
class VBA : public CWinApp
{
 public:
  ...
  bool myAIPlaying;
  char romName[13];
  Stz3AIScript* pAIScript;
  void MyAIreadData(u32 address, int len, u8 *data);
  void MyAIwriteData(u32 address, int len, u32 data);
  void MyAICallClosePython();
  ...
  bool aniRecording;
  bool autoBattle;
  CMemCompareWrite  memCompareWrite;
