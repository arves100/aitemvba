...
struct {
  ...
  { "StartMyAI", ID_MYAI_STARTMYAI },
  { "StopMyAI", ID_MYAI_STOPMYAI },

  { "StartPythonScript", ID_MYAI_STARTPYTHONSCRIPT },
  { "StopPythonScript", ID_MYAI_STOPPYTHONSCRIPT },

  { "StartAnimationRecord", ID_MYAI_STARTANIRECORD },
  { "StopAnimationRecord", ID_MYAI_STOPANIRECORD },

  { "StartWriteGMDFile", ID_MYAI_WRITEGMDFILE },

  { "StartAutoBattle", ID_MYAI_AUTOBATTLE },
  { "StopAutoBattle", ID_MYAI_STOPAUTOBATTLE },
